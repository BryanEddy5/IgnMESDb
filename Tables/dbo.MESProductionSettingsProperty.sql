CREATE TABLE [dbo].[MESProductionSettingsProperty]
(
...
GO
CREATE NONCLUSTERED INDEX [IX_EquipmentRef] ON [dbo].[MESProductionSettingsProperty] ([EquipmentRefUUID], [Enable]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_O_MESProductionSettingsProperty] ON [dbo].[MESProductionSettingsProperty] ([MESObjectUUID], [Name]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_P_MESProductionSettingsProperty] ON [dbo].[MESProductionSettingsProperty] ([MESPropertyUUID]) ON [PRIMARY]
GO
