CREATE TABLE [dbo].[MESOperationsPerformance]
(
[MESOperationsPerformanceUUID] [varchar] (36) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_MESOperationsPerformanceUUID] ON [dbo].[MESOperationsPerformance] ([MESOperationsPerformanceUUID]) ON [PRIMARY]
GO
